...
------ | --- | ------
imageSource (String)|null|The path to the image in the device
dataType (String)|Path|If you send a path, enter the string "Path"<br> If you send a Base64 string, enter the Base64 string you want to send.
